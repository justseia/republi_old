...
Route::post('/posts/{post}/like', \App\Http\Controllers\API\v1\Post\LikeController::class);
Route::post('/posts/{post}/unlike', \App\Http\Controllers\API\v1\Post\UnlikeController::class);
